                ...
                <div id="sidebar-scroll">
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="side-content side-content-full">
                            <ul class="nav-main">
                                <li>
                                    <a href="/users"><i class="fa fa-user-circle"></i><span class="sidebar-mini-hide">Пользователи</span></a>
                                </li>
                                <li>
                                    <a href="/accounts"><i class="fa fa-instagram"></i><span class="sidebar-mini-hide">Instagram аккаунты</span></a>
                                </li>
                                <li>
                                    <a href="/tasks"><i class="fa fa-paper-plane"></i><span class="sidebar-mini-hide">Задачи</span></a>
                                </li>
                            </ul>
                        </div>
                        <!-- END Side Content -->
                    ...
                    <li class="js-header-search header-search">
                        <form class="form-horizontal" action="base_pages_search.html" method="post">
                            <div class="form-material form-material-primary input-group remove-margin-t remove-margin-b">
                                <input class="form-control" type="text" id="base-material-text" name="base-material-text" placeholder="Введите поиск..">
                            </div>
                        </form>
                    </li>
                </ul>
